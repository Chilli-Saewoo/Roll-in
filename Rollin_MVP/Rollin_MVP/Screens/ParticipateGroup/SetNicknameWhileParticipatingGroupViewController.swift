//
//  SetNicknameWhileParticipatingGroupViewController.swift
//  Rollin_MVP
//
//  Created by Yeji on 2022/11/11.
//

import UIKit

final class SetNicknameWhileParticipatingGroupViewController: UIViewController {
    ...
    @objc func nextButtonPressed(_ sender: UIButton) {
        ...
        let secondViewController = self.storyboard?.instantiateViewController(withIdentifier: "ConfirmGroup") as? ConfirmParticipatingGroupViewController
//        secondViewController?.nicknameText = text
//        (secondViewController as? ConfirmParticipatingGroupViewController)?.participatingGroupInfo = participatingGroupInfo
...
private extension SetNicknameWhileParticipatingGroupViewController {
